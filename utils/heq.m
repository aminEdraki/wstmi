...
% A detailed explanation is given in Sch�dler, M. R., & Kollmeier, B. 
% (2015). Separable spectro-temporal Gabor filter bank features: Reducing 
% the complexity of robust features for automatic speech recognition. The 
% Journal of the Acoustical Society of America, 137(4), 2047-2059.
%
